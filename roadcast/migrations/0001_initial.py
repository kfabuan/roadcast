# Generated by Django 3.2 on 2021-10-05 03:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Added', models.DateField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), null=True, verbose_name='Date Added')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reported_Date', models.DateField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), verbose_name='Date Reported')),
                ('Reported_Time', models.TimeField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), verbose_name='Time Reported')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Substation', models.CharField(blank=True, choices=[('Pasig City Police Station', 'Pasig City Police Station'), ('Substation 1', 'Substation 1'), ('Substation 2', 'Substation 2'), ('Substation 3', 'Substation 3'), ('Substation 4', 'Substation 4'), ('Substation 5', 'Substation 5'), ('Substation 6', 'Substation 6'), ('Substation 7', 'Substation 7'), ('Substation 8', 'Substation 8')], max_length=200, verbose_name='Substation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Response_Date', models.DateField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), null=True, verbose_name='Response Date')),
                ('Response_Time', models.TimeField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), null=True, verbose_name='Response Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Narrative', models.CharField(blank=True, max_length=900, null=True, verbose_name='Narrative')),
                ('date_added', models.DateField(blank=True, default=datetime.datetime(2021, 10, 5, 3, 28, 45, 649180, tzinfo=utc), null=True, verbose_name='Date Added')),
                ('added_by', models.CharField(blank=True, max_length=200, null=True, verbose_name='Added By')),
